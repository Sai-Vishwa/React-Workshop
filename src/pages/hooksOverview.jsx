                    ...
                    <div className="mt-10">
                        ...
                        <div className="text-2xl mt-6">
                            ...
                            <ul className="list-disc">
                                <li><code className="text-red-600 bg-slate-900 px-2 py-1 rounded-xl">useState</code></li>
                                <li className="mt-4"><code className="text-red-600 bg-slate-900 px-2 py-1 rounded-xl">useEffect</code></li>
                                <li className="mt-4"><code className="text-red-600 bg-slate-900 px-2 py-1 rounded-xl">useRef</code></li>
                                <li className="mt-4"><code className="text-red-600 bg-slate-900 px-2 py-1 rounded-xl">useMemo</code></li>
                            </ul>
                        </div>
                    </div>
                </div>
